...
def about():
    ...
    def __template__():
        ...
        yield '', join_('                  * <a href="http://userscripts-mirror.org/scripts/show/77298.html" >StackPrinter GreaseMonkey script</a><br/>\n')
...
def index():
    ...
    def __template__ (counter):
        ...
        yield '', join_('                    <li><a href="http://userscripts-mirror.org/scripts/show/77298.html" >StackPrinter GreaseMonkey script</a></li>\n')
...
myse = CompiledTemplate(myse(), 'app/views/myse.html')
...
myse_questions = CompiledTemplate(myse_questions(), 'app/views/myse_questions.html')
