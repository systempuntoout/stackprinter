...
def export():
    ...
    def __template__ (service, question , answers, pretty_links, printer):
        ...
        yield '', join_('                <a href="http://stackprinter.appspot.com/export?format=HTML&service=', escape_(service, True), '&printer=false&question=', escape_((question['question_id']), True), '"><img title="Link to this printed question" width="20px" height="20px" border="0" src="/images/Share.gif"/></a>\n')
        yield '', join_('            </div>         \n')
