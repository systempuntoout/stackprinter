...
def about():
    ...
    def __template__():
        ...
        yield '', join_('                  Using Stack Exchange Network API produces an essential printable view of a given <i>question id</i> with:<br>\n')
...
def export():
    ...
    def __template__ (service, question , answers, pretty_links, printer):
        ...
        yield '', join_('            /* 728x15, created 10/7/10 */\n')
        yield '', join_('            google_ad_slot = "7135200367";\n')
        yield '', join_('            google_ad_width = 728;\n')
        yield '', join_('            google_ad_height = 15;\n')
        yield '', join_('            //-->\n')
        yield '', join_('            </script>\n')
        yield '', join_('            <script type="text/javascript"\n')
...
def index():
    ...
    def __template__ (counter):
        ...
        yield '', join_('                  <a href="http://appgallery.appspot.com/about_app?app_id=agphcHBnYWxsZXJ5chQLEgxBcHBsaWNhdGlvbnMYndBODA"><img margin="0" border="0" src="/images/appengine.gif"/></a>\n')
        yield '', join_('              </div>                                 \n')
        yield '', join_('          </div>\n')
        yield '', join_('  </body>\n')
        yield '', join_('</html>\n')
