...
def oops():
    ...
    def __template__ (message):
        ...
        yield '', join_('                  ', escape_((message), True), '<br>\n')
        yield '', join_('                  <span style="font-size:1.4em;font-weight:bold">Request-per-day limit error?</span> [Info <a href="http://stackapps.com/questions/1713/google-app-engine-apps-we-are-all-on-the-same-quota">here</a>]\n')
        yield '', join_('             </div>                              \n')
        yield '', join_('          </center>\n')
        yield '', join_('  </body>\n')
        yield '', join_('</html>\n')
