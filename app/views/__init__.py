...
def about():
    ...
    def __template__():
        ...
        yield '', join_('                  <b>Sponsors</b><br/>\n')
        yield '', join_('                   - <a href="#">Link slot #1</a><br/>\n')
        yield '', join_('                   - <a href="#">Link slot #2</a><br/>\n')
        yield '', join_('                   - <a href="#">Link slot #3</a><br/>\n')
        yield '', join_('                   - <a href="#">Link slot #4</a><br/>\n')
        yield '', join_('                   - <a href="#">Link slot #5</a><br/>\n')
        yield '', join_('              </div>                                 \n')
        yield '', join_('          </div>\n')
        yield '', join_('  </body>\n')
        yield '', join_('</html>\n')
