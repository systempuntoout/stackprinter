...
def deleted():
    ...
    def __template__ (result):
        ...
        yield '', join_('                    <tr class="odd">\n')
        yield '', join_('                            <td class="printer">\n')
        yield '', join_('                            <a target="_blank" href="/deleted/what-real-life-bad-habits-has-programming-given-you.html"/>\n')
        ...
        yield '', join_('\n')
        yield '', join_('                            <a target="_blank" href="http://stackoverflow.com/questions/164432"/>What real life good habits has programming given you?</a><br>\n')
        yield '', join_('                            <span class="tag">\n')
        yield '', join_('                                [ polls work-habits ] \n')
        yield '', join_('                            </span>\n')
        yield '', join_('                        </td>\n')
