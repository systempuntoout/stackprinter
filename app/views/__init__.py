...
def export():
    ...
    def __template__ (service, post, pretty_links, printer, link_to_home):
        ...
        yield '', join_('            "/>\n')
        yield '', join_('            <input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" name="submit" alt="PayPal - The safer, easier way to pay online!" style="border:0"/>\n')
        yield '', join_('            <img alt="" src="https://www.paypalobjects.com/it_IT/i/scr/PayPal.gif" width="1" height="1" style="border:0"/>\n')
        yield '', join_('            </p>\n')
        yield '', join_('            </form>\n')
        yield '', join_('            \n')
        yield '', join_('            </div>         \n')
...
def index():
    ...
    def __template__ (counter):
        ...
        yield '', join_('        <meta name="keywords" content="printer-friendly printer printerfriendly stackoverflow stackapps stackexchange">\n')
