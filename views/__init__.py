...
def about():
    ...
    def __template__():
        ...
        yield '', join_('        <meta name="description" content="StackPrinter - The Stack Overflow Printer Suite">\n')
        ...
        yield '', join_('                  Produces an essential printable view of a given question id with:<br>\n')
        yield '', join_('                  * All the answers<br> \n')
        yield '', join_('                  * All the comments<br>\n')
        yield '', join_('                  <br>\n')
        yield '', join_('                  The easiest way to use this service is with:<br>\n')
        yield '', join_('                  * <a href="http://userscripts.org/scripts/source/77298.user.js" >StackPrinter GM script</a><br>\n')
        yield '', join_('                  * <a href="javascript:(function(){var linkTokens = window.location.href.split(\'/\');if (linkTokens[4]){var domainTokens= linkTokens[2].split(\'.\');var service = domainTokens[0];window.open(\'http://stackprinter.appspot.com/export?format=HTML&service=\'+service+\'&question=\'+linkTokens[4])}else{alert(\'Attention: question id not found!\')}})()">Bookmarklet</a><br>\n')
        yield '', join_('                  <br>\n')
        yield '', join_('                  <b>Favorites:</b><br>\n')
        yield '', join_('                  Supported services:<br> \n')
        yield '', join_('                  1. The Stack Overflow Trilogy<br>\n')
        yield '', join_("                  Retrieves and prints all the favorites users's questions<br>\n")
        yield '', join_('                  <br>\n')
        yield '', join_('                  2. Delicious<br>\n')
        yield '', join_('                  Retrieves the latest 100 Trilogy questions of a given Delicious username with <i>stackoverflow</i> tag (<a href="http://meta.stackoverflow.com/questions/47162/save-question-to-delicious-greasemonkey-script">more info</a>).<br>                \n')
        yield '', join_('                  To add and tag your questions to Delicious use:<br>\n')
        yield '', join_('                  * <a href="http://userscripts.org/scripts/source/74766.user.js"/>Delicious GM script</a><br>\n')
        yield '', join_('                  <br>\n')
        yield '', join_('                  <b>TopVoted:</b><br>\n')
        yield '', join_('                  Retrieves and prints the top voted questions by tags<br><br>\n')
...
def export():
    ...
    def __template__ (service, question , answers, pretty_links, printer):
        ...
        yield '', join_('                 <img width="30px" heigth="30px" src="/images/', escape_((service), True), '.png"/>&nbsp;', escape_(question['title'].replace('<', '&lt;'), True), '<br>\n')
        yield '', join_('          </div>\n')
        ...
        for comment in loop.setup(question['comments']):
            ...
            yield '', join_('                ', '</div>\n')
        for answer in loop.setup(answers):
...
def favorites():
    ...
    def __template__ (message = None):
        ...
        yield '', join_('        <script type="text/javascript" src="/javascripts/jquery.numeric.js"></script>\n')
        ...
        yield '', join_('                          <table cellpadding="0" cellspacing="0">\n')
        yield '', join_('                              <tr valign=top>\n')
        yield '', join_('                                  <td align=center nowrap>\n')
        ...
        yield '', join_('                                          <input id="favorites_button" type="button" value="Get questions"/>\n')
        yield '', join_('                                      </div>                                        \n')
        yield '', join_('                                 \n')
        yield '', join_('                                  </td>                                    \n')
        yield '', join_('                              </tr>\n')
...
def favorites_delicious():
    ...
    def __template__ (username, result):
        ...
        yield '', join_('        </div>\n')
        yield '', join_('             <p id="title" class="main">\n')
        yield '', join_('                 <img src="/images/delicious.jpg"/>&nbsp;Delicious <i>stackoverflow</i> question <br>\n')
        yield '', join_('                 <a target="_new" href="http://www.delicious.com/', escape_((username), True), '/stackoverflow">', escape_((username), True), '</a>\n')
        yield '', join_('            </p>\n')
        yield '', join_('            <table cellpadding="2" cellspacing="0">\n')
        for rown,question in loop.setup(enumerate(result)):
            if rown % 2 == 0:
...
def favorites_trilogy():
    ...
    def __template__ (username, user_id, result, service, pagination):
        ...
        yield '', join_('                <a href="/favorites"><img src="/images/search.png"/></a>\n')
        yield '', join_('            </div>\n')
        yield '', join_('             <p id="title" class="main"><img src="/images/', escape_((service), True), '.png"/>', escape_((supported_services[service]), True), '&nbsp;<i>favorites</i> questions <br>\n')
        yield '', join_('                 <a target="_new" href="http://', escape_((service), True), '.com/users/', escape_((user_id), True), '/', escape_((username), True), '">', escape_((username), True), '</a>\n')
        yield '', join_('             </p>\n')
        yield '', join_('             <table cellpadding="2" cellspacing="0">\n')
        for rown,question in loop.setup(enumerate(result)):
            if rown % 2 == 0:
            ...
            yield '', join_('                    ', '</td>    \n')
            yield '', join_('                    ', '<td class="title">\n')
            yield '', join_('                    ', '    <a target="_blank" href="', escape_(question.url, True), '"/>', escape_(question.title.replace('<', '&lt;'), True), '</a><br>\n')
            yield '', join_('                    ', '    <span class="tag">\n')
            ...
            if rown == len(result) - 1:
                ...
                yield '', join_('                    ', '    <tr>\n')
                yield '', join_('                    ', '        <td class="pagination_back">\n')
                if pagination.has_previous_entries():
                    yield '', join_('                                ', '    <a href="/favorites?service=', escape_((service), True), '&userid=', escape_((user_id), True), '&page=', escape_((pagination.page-1), True), '&pagesize=', escape_((pagination.pagesize), True), '">&laquo; back</a>\n')
                yield '', join_('                    ', '        </td>\n')
                yield '', join_('                    ', '        <td class="pagination_info">\n')
                yield '', join_('                    ', '            Page: ', escape_(pagination.page, True), ' | Pagesize: ', escape_(pagination.pagesize, True), ' | Total questions : ', escape_(pagination.total, True), '\n')
                yield '', join_('                    ', '        </td>\n')
                yield '', join_('                    ', '        <td class="pagination_more">\n')
                if pagination.has_more_entries():
                    yield '', join_('                                ', '       <a href="/favorites?service=', escape_((service), True), '&userid=', escape_((user_id), True), '&page=', escape_((pagination.page+1), True), '&pagesize=', escape_((pagination.pagesize), True), '">more &raquo;</a>   \n')
                yield '', join_('                    ', '        </td>\n')
                yield '', join_('                    ', '    </tr>\n')
                yield '', join_('                    ', '</table>\n')
        else:
...
def favorites_user_selection():
    ...
    def __template__ (users, service):
        ...
        if len(users) > 3:
            ...
            yield '', join_('                      ', '     <a class="prev">&laquo; Back</a>\n')
...
def index():
    ...
    def __template__ (counter):
        ...
        yield '', join_('                                 </div>\n')
        yield '', join_('                                 <div class="button">\n')
        yield '', join_('                                 <input id="question_button" type="button" name="format" value="Print"/>\n')
        yield '', join_('                                 </div>\n')
        yield '', join_('                              </td>                                     \n')
        yield '', join_('                          </tr>\n')
        yield '', join_('                      </table>\n')
        ...
        yield '', join_('                    <li><a href="http://userscripts.org/scripts/source/77298.user.js" >StackPrinter GM script</a></li>\n')
        yield '', join_('                    <li><a href="javascript:(function(){var re = new RegExp(\'^http://(.*?)\\.com/questions/([0-9]+)/\');var group = re.exec(window.location.href);if (group!=null){var service = group[1];var questionid=group[2];window.open(\'http://stackprinter.appspot.com/export?format=HTML&service=\'+service+\'&question=\'+questionid)}else{alert(\'Attention: question id not found!\')}})()">Bookmarklet</a></li>\n')
...
def topvoted():
    ...
    def __template__():
        ...
        yield '', join_('                            input = jQuery.trim(jQuery("#input_main").val())\n')
        yield '', join_('                    if ( input != "") {\n')
        yield '', join_('                            jQuery.cookie("TAGGED", input , { expires: 50 })\n')
        ...
        yield '', join_('                                     <div id="input_wrapper">\n')
        yield '', join_('                                         <input maxlength="60" name="tagged" value="" size="40" id="input_main">\n')
        yield '', join_('                                     </div>\n')
        yield '', join_('                                     <div>                                       \n')
        yield '', join_('                                       <select id="service" name="service">\n')
        for service_key in loop.setup(supported_services_keys):
        ...
        yield '', join_('                                      </div>\n')
        yield '', join_('                                      <div class="button">\n')
        yield '', join_('                                          <input id="topvoted_button" type="button" value="Get questions"/>\n')
        yield '', join_('                                      </div>                                        \n')
        yield '', join_('                                 \n')
        yield '', join_('                                  </td>                                    \n')
        yield '', join_('                              </tr>\n')
...
def topvoted_tagged():
    ...
    def __template__ (tagged, result, service, pagination):
        ...
        yield '', join_('            </div>\n')
        yield '', join_('             <p id="title" class="main"><img src="/images/', escape_((service), True), '.png"/>', escape_((supported_services[service]), True), '&nbsp;<i>top voted</i> questions <br>\n')
        yield '', join_('                 [<i>', escape_((tagged), True), '</i>]\n')
        yield '', join_('             </p>\n')
        yield '', join_('             <table cellpadding="2" cellspacing="0">\n')
        for rown,question in loop.setup(enumerate(result)):
            if rown % 2 == 0:
            ...
            if rown == len(result) - 1:
                ...
                yield '', join_('                    ', '        <td class="pagination_back">\n')
                if pagination.has_previous_entries():
                    yield '', join_('                                ', '    <a href="/topvoted?service=', escape_((service), True), '&tagged=', escape_((urlencode(tagged)), True), '&page=', escape_((pagination.page-1), True), '&pagesize=', escape_((pagination.pagesize), True), '">&laquo; back</a>\n')
                yield '', join_('                    ', '        </td>\n')
                yield '', join_('                    ', '        <td class="pagination_info">\n')
                yield '', join_('                    ', '            Page: ', escape_(pagination.page, True), ' | Pagesize: ', escape_(pagination.pagesize, True), ' | Total questions : ', escape_(pagination.total, True), '\n')
                yield '', join_('                    ', '        </td>\n')
                yield '', join_('                    ', '        <td class="pagination_more">\n')
                if pagination.has_more_entries():
                    yield '', join_('                                ', '       <a href="/topvoted?service=', escape_((service), True), '&tagged=', escape_((urlencode(tagged)), True), '&page=', escape_((pagination.page+1), True), '&pagesize=', escape_((pagination.pagesize), True), '">more &raquo;</a>   \n')
                yield '', join_('                    ', '        </td>\n')
                yield '', join_('                    ', '    </tr>\n')
                yield '', join_('                    ', '</table>\n')
        else:
