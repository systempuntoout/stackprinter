    ...
    def __template__ (tagged, result, service, pagination):
        ...
        for rown,question in loop.setup(enumerate(result)):
            ...
            if rown == len(result) - 1:
                ...
                yield '', join_('                    ', '        <td class="pagination_back">\n')
                if pagination.has_previous_entries():
                    yield '', join_('                                ', '    <a href="/topvoted?service=', escape_((service), True), '&tagged=', escape_((urlquote(tagged)), True), '&page=', escape_((pagination.page-1), True), '&pagesize=', escape_((pagination.pagesize), True), '">&laquo; back</a>\n')
                yield '', join_('                    ', '        </td>\n')
                yield '', join_('                    ', '        <td class="pagination_info">\n')
                yield '', join_('                    ', '            Page: ', escape_(pagination.page, True), ' | Pagesize: ', escape_(pagination.pagesize, True), ' | Total questions : ', escape_(pagination.total, True), '\n')
                yield '', join_('                    ', '        </td>\n')
                yield '', join_('                    ', '        <td class="pagination_more">\n')
                if pagination.has_more_entries():
                    yield '', join_('                                ', '       <a href="/topvoted?service=', escape_((service), True), '&tagged=', escape_((urlquote(tagged)), True), '&page=', escape_((pagination.page+1), True), '&pagesize=', escape_((pagination.pagesize), True), '">more &raquo;</a>   \n')
                yield '', join_('                    ', '        </td>\n')
                yield '', join_('                    ', '    </tr>\n')
                yield '', join_('                    ', '</table>\n')
        else:
