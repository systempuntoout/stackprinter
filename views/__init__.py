...
def about():
    ...
    def __template__():
        ...
        yield '', join_('                  * <a href="http://userscripts.org/scripts/source/77298.user.js" >StackPrinter GreaseMonkey script</a><br>\n')
...
def index():
    ...
    def __template__ (counter):
        ...
        yield '', join_('                    <li><a href="http://userscripts.org/scripts/source/77298.user.js" >StackPrinter GreaseMonkey script</a></li>\n')
...
def topvoted():
    ...
    def __template__():
        ...
        yield '', join_('                             <div id="input_wrapper">\n')
        yield '', join_('                                 <input maxlength="60" name="tagged" value="" size="30" id="input_main">\n')
        yield '', join_('                             </div>\n')
        yield '', join_('                         <div>                                       \n')
        yield '', join_('                               <select id="service" name="service">\n')
        for service_key in loop.setup(supported_services_keys):
